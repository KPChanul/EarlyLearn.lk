...
/// Concrete game logic for the Alphabet Starting-Letter game.
/// OOP: Inheritance — extends the abstract Game class.
/// OOP: Polymorphism — overrides startGame, endGame, and checkAnswer.
class AlphabetGameLogic extends Game {
  ...
  @override
  void endGame() {
    // TODO: Connect to RewardManager in a future sprint
    print("Game ended! Final Score: $score");
  }
